...
function Eyes() {
  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div
        className="relative  w-full h-full bg-cover bg-green-200"
        style={{ backgroundImage: `url('bg-doteyes.jpg')` }}
      >
        <div className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="flex items-center justify-center w-[15vw] h-[15vw] bg-zinc-100 rounded-full ">
            <div className="relative flex justify-center items-center w-2/3 h-2/3 rounded-full bg-zinc-900 uppercase">
              Play
              <div
                style={{
